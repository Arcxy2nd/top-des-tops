 ...
 * à changer.
 */
async function handleRpc({ method, hostHeader, body, tenants, serviceAccount, fetchImpl, syncFetch, runApiImpl, readOnly, redis }) {
  ...
  try {
    const result = (runApiImpl || runApi)({
      ...
      // Verrou Upstash si configuré (null = verrou de l'onglet ScriptLock).
      redis: redis || null
    });
