...
function _setCachedTokenForTests(accessToken, expiresAt) { _cachedToken = { accessToken, expiresAt }; }

module.exports = { getAccessToken, _buildAssertion, _resetTokenCacheForTests, _setCachedTokenForTests };
